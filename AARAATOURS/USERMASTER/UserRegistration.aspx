<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserRegistration.aspx.cs" Inherits="AARAATOURS.USERMASTER.UserRegistration" %>
            ...
            <center>
                        <table style="width: 448px; height: 440px; background-color: #FF9933; font-size: large; font-weight: bold;">
                            <th colspan="2" align="center">
                                <img src="images/snup2.png" id="" width="100px" style="height: 40px" />
                            </th>
                            <tr>
                                <td align="center">User ID</td>
                                <td align="center">
                                    <asp:Label ID="lbl_u_id" runat="server" Text="ID"></asp:Label>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <asp:TextBox ID="txt_user_name" runat="server" placeholder="Enter Name"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <asp:TextBox ID="txt_user_mobile" runat="server" placeholder="Enter Mobile No"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <asp:TextBox ID="txt_user_email" runat="server" placeholder="Enter Email Id"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <asp:TextBox ID="txt_pass" runat="server" placeholder=" Enter Password"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <asp:TextBox ID="txt_Confirm_pass" runat="server" placeholder="Cofirm Password"></asp:TextBox>
                            ...
                            <tr>
                                <td colspan="2" align="center">
                                  <%--  <asp:Button ID="btn_submit_user" runat="server" Text="Submit" BackColor="#669900" Font-Bold="True" Font-Size="Large" ForeColor="White" OnClick="btn_submit_user_Click"></asp:Button>
