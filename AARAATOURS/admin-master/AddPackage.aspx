<%@ Page Language="C#" MasterPageFile="~/admin-master/admin_dashboard.Master" AutoEventWireup="true" CodeBehind="AddPackage.aspx.cs" Inherits="AARAATOURS.admin_master.AddPackage" %>
            ...
            <form runat="server">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <asp:TextBox ID="TextBox3" runat="server" class="form-control p-2" placeholder="Enter Category Name"></asp:TextBox>
                ...
                <div class="mt-4">
                    <asp:Button ID="Button1" runat="server" Text="Add Package" class="btn btn-gradient bg-info text-white fs-6 fw-semibold tracking-wide" OnClick="Button1_Click" />
                </div>
            </form>
        </div>
